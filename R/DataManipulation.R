...
#' @param predictionsinterval The intervals to predict between differential time points, default = 1
...
datamanipulation=function(input_list=input_list,differentialtimevaryingpredictors=NULL,outcome=NULL,data=NULL,ID="ID",Time=NULL,standardized=TRUE,predictionstart=NULL,predictionsend=NULL,predictionsinterval=NULL){
  #library(plyr)
  #library(zoo)
  #library(reshape2)
